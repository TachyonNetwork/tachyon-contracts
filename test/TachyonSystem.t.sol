...
contract TachyonSystemTest is Test {
    ...
    function testGreenEnergyVerification() public {
        ...
        bytes32 messageHash = keccak256(
            abi.encodePacked(node1, uint256(1), uint256(80), certificateData)
        );
    ...
    function testZKProofValidation() public {
        ...
        rewardManager.submitTaskCompletion(
            bytes32("testTask"),
    ...
    function setNodeGreenStatus() internal {
        ...
        bytes32 messageHash = keccak256(
            abi.encodePacked(node1, uint256(1), uint256(90), certificateData)
        );
